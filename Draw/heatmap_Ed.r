...
d.m <-melt(d,measure.vars=colnames(d))
...
p <- p + scale_fill_gradient(low = "white",high = "#3CB371")  ### "#3CB371"green "#ffff99" yellow  "#3399FF" blue, "#9933FF" purple
...
raws = dim(d)[1]
if(raws <= 2) {w = 3} else {w = (raws - 2)*0.4 +3}
