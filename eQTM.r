...
input_dir  = '/data2/myang9/SexAnnoDB/data/eQTM_infile/'
...
output_dir = '/data2/myang9/SexAnnoDB/output/Network/eQTM/'
...
output_file_name_all=paste0(output_dir,cancertype,'_',type,"_eQTM_all.",".txt")
output_file_name_cis = paste0(output_dir,cancertype,'_',type,"_eQTM_cis",".txt")
output_file_name_tra = paste0(output_dir,cancertype,'_',type,"_eQTM_tra",".txt")
