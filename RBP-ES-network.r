...
pandaDiffEdges <- function(panda.net1, panda.net2, threshold=0.98, condition_name="cond.1"){
  ...
  merged.net <- merge(panda.net1, panda.net2, by=c("RBP","Gene"))
  ...
  sub.net1 <- sub.net1[,c("RBP","Gene","Score.x",'net1_threshold', condition_name)]
  
  colnames(sub.net1) <- c("RBP","Gene","net1_Score",'net1_threshold',"net1_name")
...
#load_file_name = paste("RBP_","saved_",i,".RData",sep = "", collapse = "")
#  load(load_file_name)

male_file_name = paste("RBP_save_net_",i,"_turmol_male_net.txt",sep = "", collapse = "")
female_male_file_name = paste("RBP_save_net_",i,"_turmol_female_net.txt",sep = "", collapse = "")


turmol_male_net_reshaped =  read.table(male_file_name,header = T)
turmol_female_net_reshaped = read.table(female_male_file_name,header = T)
...
diffRes_turmol_male_turmol_female_filter = diffRes_turmol_male_turmol_female %>%
  ...
  diff_edge_name_diffRes_turmol_male_turmol_female = paste("RBP_",i,"_threshold_diff_edge","_turmol_male_turmol_female",".txt",sep = "", collapse = "")
  diff_edge_name_diffRes_turmol_male_turmol_female_filter = paste("RBP_",i,"_filter_threshold_diff_edge","_turmol_male_turmol_female",".txt",sep = "", collapse = "")
