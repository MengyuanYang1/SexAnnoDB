...
input_dir  = '/data2/myang9/SexAnnoDB/data/eQTL_input/'
output_dir = ''
...
output_dir = '/data2/myang9/SexAnnoDB/output/Network/eQTL/'
snp_file_name=paste0(input_dir,cancertype,'_',type,'_SNP_hg38.txt')
PSI_file_name= paste0(input_dir,cancertype,'_',type,'_FPKM_select.txt')
output_file_name_all=paste0(output_dir,cancertype,'_',type,"_all_eQTL_out.txt")
output_file_name_cis = paste0(output_dir,cancertype,'_',type,"_eQTL_cis",".txt")
output_file_name_tra = paste0(output_dir,cancertype,'_',type,"_eQTL_tra",".txt")
...
psi_pos_file_name = paste(input_dir,"Gene_position.txt",sep="")
